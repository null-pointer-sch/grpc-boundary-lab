...
const file_proto_coffee_shop_proto_rawDesc = "" +
	"\n" +
	"\x17proto/coffee_shop.proto\x12\n" +
	"coffeeshop\"\r\n" +
	"\vMenuRequest\"/\n" +
	"\x05Order\x12&\n" +
	...
	"\x04cost\x18\x03 \x01(\tR\x04cost2\xc0\x01\n" +
	"\n" +
	"CoffeeShop\x128\n" +
	...
	"\x0eGetOrderStatus\x12\x13.coffeeshop.Receipt\x1a\x17.coffeeshop.OrderStatus\"\x00BVZTgithub.com/null-pointer-sch/grpc-boundary-lab/tutorial/01-grpc-go-basics/proto;protob\x06proto3"
